   ...
   <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class=""><a href="javaScript:;" onclick="$('#frame').load('./modulo/iniciousuario.php')"><span class="glyphicon glyphicon-home"></span> Inicio</a></li>
        <li><a id="esve" href="javaScript:;" onclick="$('#frame').load('./modulo/inscribir_evento.php')"><span class="glyphicon glyphicon-glass"></span>Eventos</a></li>
        <li><a href="javaScript:;" onclick="$('#frame').load('./modulo/extracto_usuario.php')"><span class="glyphicon glyphicon-open"></span>Ver Extractos</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
<div class="container wel"> <!-- CONTENIDO -->
	<div class="row">
		...
		<label class="col-md-8"><?php echo $n; ?> <a class="cerrar" href="script/cerrar.php"> <span class="glyphicon glyphicon-log-out"></span> Cerrar Sesión </a></label>
		</div>
	</div>
</div>
